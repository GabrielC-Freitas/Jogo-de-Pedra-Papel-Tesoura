...
def jogar(i):
    ...
    if rondas >0:
        ...
        # movendo para frente #['Pedra', 'Papel', 'Tesoura']
        ...
        # movendo para tras  #['Pedra', 'Papel', 'Tesoura']
...
def iniciar_jogo():
    ...
    icon_2 = icon_2.resize((70,70), Image.ANTIALIAS)
    ...
    icon_3 = icon_3.resize((70,70), Image.ANTIALIAS)
...
def fim_do_jogo():
    ...
    if jogador_voce > jogador_pc:
        app_vencedor = Label(frame_baixo, text="You Win! Congratulations!", height=1, anchor='center', font=('Ivy 10 bold'), bg=co0, fg=co4)
        app_vencedor.place(x=5, y=60)
    elif jogador_voce < jogador_pc:
        app_vencedor = Label(frame_baixo, text="You lost, humanity will no longer exist!", height=1, anchor='center', font=('Ivy 10 bold'), bg=co0, fg=co5)
        app_vencedor.place(x=5, y=60)
    else:
        app_vencedor = Label(frame_baixo, text="Humanity and robots tied!", height=1, anchor='center', font=('Ivy 10 bold'), bg=co0, fg=co1)
        app_vencedor.place(x=5, y=60)
